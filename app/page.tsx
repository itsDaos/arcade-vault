...
function GameCard({ game }: { game: Game }) {
  ...
  return (
    <div ref={ref} className="card" onMouseMove={onMove} onMouseLeave={onLeave} onClick={() => router.push(`/games/${game.id}`)}>
      <div className="cover">
      ...
      <div className="meta">
        ...
        <div className="row">
          ...
          <button className={btnClass} onClick={(e) => { e.stopPropagation(); router.push(`/games/${game.id}`) }}>
            JUGAR
          </button>
        </div>
      </div>

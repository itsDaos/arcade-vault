      ...
      <section className="home-hero">
        ...
        <div className="home-hero-inner">
          ...
          <h1 className="home-title">
            <span className="line-1">DAOS</span>
            <span className="line-2">ES UN DURO</span>
            <span className="line-3">Y PUEDE CON TODO</span>
          </h1>
          <p className="home-sub">
            Daos no conoce el límite. Enfrenta cualquier reto, domina cada
            partida y demuestra que no hay arcade ni desafío que se le resista.
            <br />
            Sin descargas. Sin costo. Solo Daos.
          </p>

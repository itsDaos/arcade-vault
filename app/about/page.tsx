          ...
          <form className={`contact-form${shake ? ' shake' : ''}`} onSubmit={onSubmit}>
            {status === 'success' ? (
              <div className="terminal-success">
                ...
                <div className="term-body">
                  ...
                  <div className="line success">
                    &gt; MENSAJE RECIBIDO. TE RESPONDEREMOS PRONTO. GRACIAS, {form.name.toUpperCase()}.<span className="caret">_</span>
                  </div>
              ...
              <>
                ...
                {status === 'error' && (
                  <p style={{ color: 'var(--magenta)', fontSize: 12, marginBottom: 12 }}>{errorMsg}</p>
                )}
                <button
                  ...
                  disabled={status === 'loading'}
                >
                  {status === 'loading' ? 'ENVIANDO…' : (status === 'error' ? '▶  REINTENTAR' : '▶  ENVIAR MENSAJE')}
                </button>
              </>
            )}
          </form>
